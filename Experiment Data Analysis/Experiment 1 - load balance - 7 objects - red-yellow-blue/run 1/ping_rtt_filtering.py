...
file_path = r"C:\Users\demet\Documents\GitHub\Drone-Car-Collaboration\Experiment Data Analysis\Experiment 1 - load balance - 7 objects - red-yellow-blue\run 1\ping_results_2023-07-23_12-42-02.txt"
...
plt.ylabel('RTT (ms)')
plt.title('Aggregated RTT Data Analysis - Experiment 1, Run 1 - Load Balance Drone-Car')
plt.legend()
plt.grid(True)
plt.show()
